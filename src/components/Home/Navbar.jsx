      ...
      <nav className="flex items-center justify-between lg:max-w-[80%] w-5/6 mx-auto h-20 ">
        ...
        <div className={menuIconClicked ? "flex lg:hidden" : "hidden"}>
          <ul className="flex items-center justify-center flex-col absolute right-5 top-16 gap-4 border-2 border-gray-300 bg-custom1 py-2 px-3 rounded-xl text-white z-20 ">
            ...
            <li className="hover:text-custom1 hover:bg-white hover:cursor-pointer w-full text-center px-2 py-1 rounded-xl flex items-center justify-center" onClick={() => setAboutWindowOpen(!aboutWindowOpen)}> {aboutWindowOpen && <IoMdArrowDropleft color="#ed563b" />}ABOUT</li>
            <Link to={""}><li className="hover:text-custom1 hover:bg-white hover:cursor-pointer w-full text-center px-2 py-1 rounded-xl flex items-center justify-center">CONTACT</li></Link>
          </ul>
        </div>
        ...
        <div>
          <ul className="flex flex-col absolute top-16 lg:bg-black bg-custom1 border-white lg:opacity-50 border-2 lg:border-black py-3 px-5 gap-3  lg:shadow-lg z-20 lg:right-1/3 rounded-xl lg:rounded-none right-60 translate-x-1/2 thext-white" style={{ display: aboutWindowOpen && menuIconClicked ? 'flex' : 'none' }}>
            ...
            <Link to={"/testimonials"}><li className="text-sm text-white  font-semibold hover:text-custom1 hover:cursor-pointer">TESTIMONIALS</li></Link>
            <Link to={"/faq"}><li className="text-sm text-white font-semibold hover:text-custom1 hover:cursor-pointer">FAQ</li></Link>
            <Link to={"/terms"}><li className="text-sm text-white font-semibold hover:text-custom1 hover:cursor-pointer">TERMS</li></Link>
          </ul>
        </div>
      </nav>
    </div>
