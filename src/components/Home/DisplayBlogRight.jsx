...
const DisplayBlogRight = ({ img = img1, selected, button, paragraph, description }) => {
  return (
    <div className={selected===button?"block":"hidden"}>
      ...
      <div className="blog-details">
        <p className="my-6 text-xl font-extrabold">
          {paragraph}
        </p>
      </div>
      ...
      <div className="continue-reading-btn">
        <button className="text-white bg-red-500 py-2 px-4 text-sm">
          CONTINUE READING
        </button>
      </div>
    </div>
